(() => {
  ...
  // ../erpnext/node_modules/html2canvas/dist/html2canvas.js
  var require_html2canvas = __commonJS({
    "../erpnext/node_modules/html2canvas/dist/html2canvas.js"(exports, module) {
      (function(global, factory) {
        ...
        var parseColorStop = function(args) {
          var color2 = color$1.parse(args[0]);
          var stop = args[1];
          ...
          parseFunctionArgs(tokens).forEach(function(arg, i2) {
            ...
            if (firstToken.type === TokenType.FUNCTION) {
              if (firstToken.name === "from") {
                var color2 = color$1.parse(firstToken.values[0]);
                ...
                if (values.length === 2) {
                  var color2 = color$1.parse(values[1]);
                  var stop_1 = values[0];
        ...
        var parseColor$1 = function(value) {
          return color$1.parse(Parser.create(value).parseComponentValue());
        };
          ...
          function IFrameElementContainer2(iframe) {
            ...
            try {
              if (iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.documentElement) {
                ...
                var documentBackgroundColor = iframe.contentWindow.document.documentElement ? parseColor$1(getComputedStyle(iframe.contentWindow.document.documentElement).backgroundColor) : COLORS.TRANSPARENT;
                var bodyBackgroundColor = iframe.contentWindow.document.body ? parseColor$1(getComputedStyle(iframe.contentWindow.document.body).backgroundColor) : COLORS.TRANSPARENT;
            ...
            if (isTextNode(childNode) && childNode.data.trim().length > 0) {
              ...
              if (isSlotElement(childNode) && childNode.assignedNodes) {
                childNode.assignedNodes().forEach(function(childNode2) {
                  return parseNodeTree(childNode2, parent, root);
                });
              } else {
        ...
        var ElementPaint = function() {
          ...
          ElementPaint2.prototype.getParentEffects = function() {
            ...
            if (this.container.styles.overflowX !== OVERFLOW.VISIBLE) {
              ...
              var paddingBox2 = calculatePaddingBoxPath(this.curves);
              if (!equalPath(borderBox, paddingBox2)) {
                effects.push(new ClipEffect(paddingBox2, 2 | 4));
              }
            }
            return effects;
          };
          ...
          return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
              switch (_b.label) {
                ...
                case 1:
                  container = _b.sent();
                  documentBackgroundColor = ownerDocument.documentElement ? parseColor(getComputedStyle(ownerDocument.documentElement).backgroundColor) : COLORS.TRANSPARENT;
                  bodyBackgroundColor = ownerDocument.body ? parseColor(getComputedStyle(ownerDocument.body).backgroundColor) : COLORS.TRANSPARENT;
                  bgColor = opts.backgroundColor;
                  defaultBackgroundColor = typeof bgColor === "string" ? parseColor(bgColor) : bgColor === null ? COLORS.TRANSPARENT : 4294967295;
  ...
  // ../erpnext/erpnext/public/js/hierarchy_chart/hierarchy_chart_desktop.js
  ...
  erpnext.HierarchyChart = class {
    ...
    show() {
      this.setup_actions();
      if ($(`[data-fieldname="company"]`).length)
        return;
      let me = this;
  ...
  // ../erpnext/erpnext/public/js/hierarchy_chart/hierarchy_chart_mobile.js
  erpnext.HierarchyChartMobile = class {
    ...
    setup_hierarchy() {
      ...
      this.$hierarchy = $(`<ul class="hierarchy-mobile">
    ...
    expand_node(node) {
      ...
      if (this.$sibling_group) {
        ...
        if (node.parent_id !== void 0 && node.parent_id != sibling_parent)
          this.$sibling_group.empty();
      }
      if (!is_same_node) {
  ...
  // frappe-html:/home/taha/frappe-bench6/apps/erpnext/erpnext/public/js/templates/node_card.html
			...
			<div class="node-info d-flex flex-row mb-1">
				...
				{% if is_mobile %}
					<div class="node-connections text-muted ml-2 ellipsis">
						\xB7 {{ connections }} <span class="fa fa-level-down"></span>
					</div>
				{% else %}
					{% if connections == 1 %}
						<div class="node-connections text-muted ml-2 ellipsis">\xB7 {{ connections }} Connection</div>
					{% else %}
						<div class="node-connections text-muted ml-2 ellipsis">\xB7 {{ connections }} Connections</div>
					{% endif %}
				{% endif %}
			</div>
		</div>
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
//# sourceMappingURL=hierarchy-chart.bundle.7AMCDLOF.js.map
